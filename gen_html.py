...
deadline_samples = [
  {'id':'DL-001','category':'교정','item':'가스감지기 정기교정','target':'GD-001','material':'NH3',
   'baseDate':'2026-06-14','dueDate':'2026-12-14','prepDate':'2026-11-14','doneDate':'','manager':'한상휘',
   'needsEvidence':'Y','relatedMenu':'가스감지기 관리','relatedId':'GD-001','note':'6개월 주기 교정'},
  {'id':'DL-002','category':'검사','item':'유해화학물질 정기검사','target':'5F Gas Room','material':'NH3,HF,SiF4',
   'baseDate':'2026-06-14','dueDate':'2026-08-30','prepDate':'2026-07-30','doneDate':'','manager':'한상휘',
   'needsEvidence':'Y','relatedMenu':'정기검사','relatedId':'HI001','note':''},
  {'id':'DL-003','category':'교육','item':'종사자교육','target':'전체 출입자','material':'',
   'baseDate':'2026-06-14','dueDate':'2026-07-10','prepDate':'2026-06-24','doneDate':'','manager':'한상휘',
   'needsEvidence':'Y','relatedMenu':'교육관리','relatedId':'EDU-WT','note':'연간 1회 의무'},
  {'id':'DL-004','category':'신고','item':'유해화학물질 도급신고','target':'특수가스 배관업체','material':'NH3',
   'baseDate':'2026-06-01','dueDate':'2026-06-05','prepDate':'2026-05-29','doneDate':'','manager':'한상휘',
   'needsEvidence':'Y','relatedMenu':'도급신고 관리','relatedId':'C-001','note':'작업 전 신고 필요'},
  {'id':'DL-005','category':'검사','item':'고압가스 완성검사','target':'NH3 VMB','material':'NH3',
   'baseDate':'2026-01-10','dueDate':'2026-03-31','prepDate':'2026-03-01','doneDate':'2026-03-25','manager':'한상휘',
   'needsEvidence':'Y','relatedMenu':'정기검사','relatedId':'HG001','note':'완료'}
]
deadline_js = json.dumps(deadline_samples, ensure_ascii=False)

# ── Evidence samples ───────────────────────────────────
evidence_samples = [
  {'id':'DOC-001','docType':'성적서','relatedWork':'가스감지기 교정','relatedId':'DL-001',
   'docName':'GD-001 NH3 검교정 성적서','target':'GD-001','issueDate':'2026-06-01',
   'expireDate':'2026-12-14','storage':'사내 공유폴더/감지기/교정','link':'','status':'보관중','manager':'한상휘','note':''},
  {'id':'DOC-002','docType':'검사필증','relatedWork':'정기검사','relatedId':'DL-002',
   'docName':'5F Gas Room 정기검사 필증','target':'5F Gas Room','issueDate':'',
   'expireDate':'','storage':'','link':'','status':'미등록','manager':'한상휘','note':'발급 예정'},
  {'id':'DOC-003','docType':'수료증','relatedWork':'교육','relatedId':'DL-003',
   'docName':'종사자교육 수료증 (2026)','target':'전체 출입자','issueDate':'2026-03-15',
   'expireDate':'2027-03-14','storage':'사내 공유폴더/교육/수료증','link':'','status':'등록','manager':'한상휘','note':''},
  {'id':'DOC-004','docType':'신고서','relatedWork':'도급신고','relatedId':'DL-004',
   'docName':'도급신고 접수증','target':'특수가스 배관업체','issueDate':'',
   'expireDate':'','storage':'확인필요','link':'','status':'확인필요','manager':'한상휘','note':'접수 여부 미확인'}
]
evidence_js = json.dumps(evidence_samples, ensure_ascii=False)

# ── MSDS samples ──────────────────────────────────
msds_samples = [
  {'id':'MSDS-001','name':'NH3','nameEn':'Ammonia','cas':'7664-41-7','supplier':'Linde',
   'location':'5F Gas Room','storage':'Gas Cabinet',
   ...
   'relatedSopId':'SOP-001','status':'정상','manager':'한상휘','note':''},
  {'id':'MSDS-002','name':'HF','nameEn':'Hydrogen Fluoride','cas':'7664-39-3','supplier':'Air Liquide',
   'location':'5F Gas Room','storage':'Gas Cabinet',
   'isHazChem':'Y','isHP':'Y','category':'독성·부식성',
   'hasMsds':'보유','revDate':'2025-12-01','lastCheckDate':'2026-04-01','nextCheckDate':'2026-10-01',
   'postLocation':'5F Gas Room 게시함','link':'','label':'완료','eduLinked':'완료',
   'relatedSopId':'','status':'SOP 미연계','manager':'한상휘','note':'SOP 작성 예정'},
  {'id':'MSDS-003','name':'SiF4','nameEn':'Silicon Tetrafluoride','cas':'7783-61-1','supplier':'Linde',
   'location':'5F Gas Room','storage':'Gas Cabinet',
   'isHazChem':'Y','isHP':'Y','category':'독성',
   'hasMsds':'확인필요','revDate':'','lastCheckDate':'','nextCheckDate':'2026-08-01',
   'postLocation':'','link':'','label':'확인필요','eduLinked':'해당없음',
   'relatedSopId':'','status':'확인필요','manager':'한상휘','note':'MSDS 보유 여부 확인 필요'},
  {'id':'MSDS-004','name':'N2','nameEn':'Nitrogen','cas':'7727-37-9','supplier':'Linde',
   'location':'Utility Area','storage':'탱크',
   'isHazChem':'N','isHP':'Y','category':'질식성',
   'hasMsds':'보유','revDate':'2025-06-01','lastCheckDate':'2026-01-01','nextCheckDate':'2026-07-01',
   'postLocation':'Utility Area 게시함','link':'','label':'완료','eduLinked':'해당없음',
   'relatedSopId':'','status':'정상','manager':'한상휘','note':''},
  {'id':'MSDS-005','name':'H2','nameEn':'Hydrogen','cas':'1333-74-0','supplier':'Linde',
   'location':'Gas Room','storage':'Gas Cabinet',
   ...
   'relatedSopId':'','status':'교육연계 필요','manager':'한상휘','note':'교육 자료에 H2 안전 내용 추가 필요'}
]
...
sop_samples = [
  {'id':'SOP-001','sopName':'NH3 실린더 교체 SOP','workType':'실린더 교체','material':'NH3',
   'facility':'NH3 Gas Cabinet','relatedMsdsId':'MSDS-001',
   'version':'Rev.1','initDate':'2026-01-10','lastRevDate':'2026-06-01','nextReviewDate':'2027-06-01',
   'author':'한상휘','reviewer':'팀장','approver':'소장','approvalStatus':'승인완료',
   'eduLinked':'완료',
   'ppe':'내화학복, 내화학 장갑, 고글, Face Shield, 방독마스크(NH3용)',
   'beforeWork':'MSDS 확인, 작업허가 취득, 환기 확인, LOTO 적용, PPE 착용, 가스감지기 알람 확인',
   'duringWork':'감시자 배치, 환기 유지, 감지기 상태 모니터링, 누출 여부 확인',
   'afterWork':'Leak Test 실시, 밸브 정상 복구 확인, 작업기록 작성, LOTO 해제',
   'emergency':'누출 시 즉시 차단 → 대피 → 보고 → 응급조치 (흡입 시 신선한 공기, 피부 노출 시 세척)',
   'link':'','status':'정상','manager':'한상휘','note':''},
  {'id':'SOP-002','sopName':'HF 배관작업 SOP','workType':'배관작업','material':'HF',
   'facility':'HF Gas Cabinet','relatedMsdsId':'MSDS-002',
   'version':'Rev.0','initDate':'2026-03-01','lastRevDate':'2026-03-01','nextReviewDate':'2027-03-01',
   'author':'한상휘','reviewer':'팀장','approver':'','approvalStatus':'검토중',
   'eduLinked':'완료',
   'ppe':'내화학복(HF용), 내화학 장갑(HF용), 고글, Face Shield, 방독마스크(HF용), 칼슘글루코네이트 겔 상시 휴대',
   'beforeWork':'MSDS 확인, HF 응급처치 훈련 이수 확인, 작업허가 취득, N2 Purge, PPE 착용',
   'duringWork':'감시자 배치, HF 감지기 상시 확인, 누출부위 육안 확인, 최소 인원 투입',
   'afterWork':'Leak Test 실시, N2 Purge 후 복구, 밸브 잠금 확인, 기록 작성',
   'emergency':'HF 누출 시 즉시 대피, 피부 노출 시 칼슘글루코네이트 겔 도포, 즉시 의료진 연락',
   'link':'','status':'승인필요','manager':'한상휘','note':'승인자 확정 후 최종 승인 예정'},
  {'id':'SOP-003','sopName':'SiF4 Hook-up SOP','workType':'Hook-up','material':'SiF4',
   'facility':'SiF4 Gas Cabinet','relatedMsdsId':'',
   'version':'','initDate':'','lastRevDate':'','nextReviewDate':'',
   'author':'한상휘','reviewer':'','approver':'','approvalStatus':'작성중',
   'eduLinked':'해당없음',
   'ppe':'내화학복, 방독마스크(SiF4용), 고글',
   'beforeWork':'','duringWork':'','afterWork':'',
   'emergency':'',
   'link':'','status':'MSDS 미연계','manager':'한상휘','note':'MSDS 확인 후 작성 예정'},
  {'id':'SOP-004','sopName':'가스감지기 알람 대응 SOP','workType':'비상대응','material':'공통',
   'facility':'Gas Detector','relatedMsdsId':'해당없음',
   'version':'Rev.1','initDate':'2025-12-01','lastRevDate':'2026-01-01','nextReviewDate':'2027-01-01',
   'author':'한상휘','reviewer':'팀장','approver':'소장','approvalStatus':'승인완료',
   'eduLinked':'필요',
   'ppe':'방독마스크, 보호복 (현장 상황에 따라)',
   'beforeWork':'알람 발생 원인 초동 확인, 대피 준비 태세 확인',
   'duringWork':'가스 종류·농도 확인, 필요 시 대피 지시, 비상연락 체계 가동',
   'afterWork':'원인 조사 및 기록, 재발 방지 대책 수립',
   'emergency':'알람 지속 시 즉시 대피 → 비상연락 → 소방서 신고',
   'link':'','status':'교육연계 필요','manager':'한상휘','note':'교육 시 비상대응 훈련 포함 필요'}
]
