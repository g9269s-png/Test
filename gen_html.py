...
# ── Deadline samples (기준일 2026-06-14) ──────────────
deadline_samples = [
  {'id':'DL-001','category':'교정','item':'가스감지기 정기교정 (상반기)','target':'GD-001~GD-010 전체','material':'NH3,HF,H2,SiF4,NF3',
   'baseDate':'2026-06-14','dueDate':'2026-07-15','prepDate':'2026-06-24','doneDate':'','manager':'한상휘',
   'needsEvidence':'Y','relatedMenu':'가스감지기 관리','relatedId':'GD-001','note':'교정업체 예약 완료 (C-002)'},
  {'id':'DL-002','category':'검사','item':'유해화학물질 취급시설 정기검사','target':'5F Gas Room (NH3,HF,SiF4)','material':'NH3,HF,SiF4',
   'baseDate':'2026-06-14','dueDate':'2026-08-30','prepDate':'2026-07-30','doneDate':'','manager':'한상휘',
   'needsEvidence':'Y','relatedMenu':'정기검사','relatedId':'HI001','note':'환경부 지정 검사기관 섭외 필요'},
  {'id':'DL-003','category':'교육','item':'유해화학물질 종사자 교육 (연간)','target':'전체 출입자 100명','material':'',
   'baseDate':'2026-06-14','dueDate':'2026-07-10','prepDate':'2026-06-24','doneDate':'','manager':'한상휘',
   'needsEvidence':'Y','relatedMenu':'교육관리','relatedId':'EDU-WT','note':'16명 미이수 — 이수 독촉 필요'},
  {'id':'DL-004','category':'신고','item':'유해화학물질 취급 도급신고','target':'특수가스 배관업체 (C-001)','material':'NH3',
   'baseDate':'2026-06-01','dueDate':'2026-06-28','prepDate':'2026-06-20','doneDate':'','manager':'한상휘',
   'needsEvidence':'Y','relatedMenu':'도급신고 관리','relatedId':'C-001','note':'작업 7일 전 신고 필수 — 준비중'},
  {'id':'DL-005','category':'검사','item':'고압가스 완성검사 (NH3 VMB)','target':'NH3 VMB','material':'NH3',
   'baseDate':'2026-01-10','dueDate':'2026-03-31','prepDate':'2026-03-01','doneDate':'2026-03-25','manager':'한상휘',
   'needsEvidence':'Y','relatedMenu':'정기검사','relatedId':'HG001','note':'완료 — 검사필증 수령'},
  {'id':'DL-006','category':'검사','item':'고압가스 정기검사 (H2 GC 2BT)','target':'H2 Gas Cabinet (2BT)','material':'H2',
   'baseDate':'2026-06-14','dueDate':'2026-07-05','prepDate':'2026-06-25','doneDate':'','manager':'한상휘',
   'needsEvidence':'Y','relatedMenu':'정기검사','relatedId':'HG004','note':'D-21 — 서류 준비 시작 필요'},
  {'id':'DL-007','category':'교정','item':'NH3 감지기 차기 교정','target':'GD-001, GD-006','material':'NH3',
   'baseDate':'2026-01-15','dueDate':'2026-07-15','prepDate':'2026-06-30','doneDate':'','manager':'한상휘',
   'needsEvidence':'Y','relatedMenu':'가스감지기 관리','relatedId':'GD-001','note':'교정일 DL-001과 병합 처리 가능'},
  {'id':'DL-008','category':'검사','item':'NH3 Gas Cabinet 정기검사','target':'NH3 Gas Cabinet (5F)','material':'NH3',
   'baseDate':'2026-06-14','dueDate':'2026-08-10','prepDate':'2026-07-20','doneDate':'','manager':'한상휘',
   'needsEvidence':'Y','relatedMenu':'정기검사','relatedId':'HI005','note':''},
  {'id':'DL-009','category':'교육','item':'취급자 교육 (기술기획파트)','target':'기술기획파트 취급자 10명','material':'',
   'baseDate':'2026-06-14','dueDate':'2026-08-31','prepDate':'2026-08-01','doneDate':'','manager':'한상휘',
   'needsEvidence':'Y','relatedMenu':'교육관리','relatedId':'EDU-HT','note':'2명 미이수 — 연간 2회 의무'}
]
deadline_js = json.dumps(deadline_samples, ensure_ascii=False)

# ── Evidence samples ───────────────────────────────────
evidence_samples = [
  {'id':'DOC-001','docType':'성적서','relatedWork':'가스감지기 교정 (2026-상반기)','relatedId':'DL-001',
   'docName':'GD-004 HF 감지기 검교정 성적서 (2026-02)','target':'GD-004','issueDate':'2026-02-07',
   'expireDate':'2026-08-07','storage':'사내 공유폴더/GD/교정/2026','link':'','status':'보관중','manager':'한상휘','note':''},
  {'id':'DOC-002','docType':'성적서','relatedWork':'가스감지기 교정 (2026-상반기)','relatedId':'DL-001',
   'docName':'GD-001 NH3 감지기 검교정 성적서 (2026-01)','target':'GD-001','issueDate':'2026-01-17',
   'expireDate':'2026-07-17','storage':'사내 공유폴더/GD/교정/2026','link':'','status':'만료임박','manager':'한상휘','note':'차기 교정 DL-001 예약 완료'},
  {'id':'DOC-003','docType':'검사필증','relatedWork':'고압가스 완성검사','relatedId':'DL-005',
   'docName':'NH3 VMB 고압가스 완성검사 필증','target':'NH3 VMB','issueDate':'2026-03-25',
   'expireDate':'2027-03-24','storage':'사내 공유폴더/정기검사/2026/NH3-VMB','link':'','status':'등록','manager':'한상휘','note':'완성검사 통과'},
  {'id':'DOC-004','docType':'수료증','relatedWork':'종사자 교육 (2026)','relatedId':'DL-003',
   'docName':'유해화학물질 종사자교육 수료증 (2026-03)','target':'전체 출입자 (84명 이수)','issueDate':'2026-03-15',
   'expireDate':'2027-03-14','storage':'사내 공유폴더/교육/수료증/2026','link':'','status':'등록','manager':'한상휘','note':'16명 미이수 — 추가 교육 일정 수립 중'},
  {'id':'DOC-005','docType':'신고서','relatedWork':'도급신고 (C-001)','relatedId':'DL-004',
   'docName':'유해화학물질 취급 도급신고서 (특수가스 배관업체)','target':'C-001','issueDate':'',
   'expireDate':'','storage':'준비중','link':'','status':'준비중','manager':'한상휘','note':'2026-06-28 제출 예정'},
  {'id':'DOC-006','docType':'검사필증','relatedWork':'정기검사 (HI005)','relatedId':'DL-008',
   'docName':'NH3 Gas Cabinet 정기검사 필증','target':'NH3 Gas Cabinet (5F)','issueDate':'',
   'expireDate':'','storage':'','link':'','status':'미등록','manager':'한상휘','note':'2026-08 검사 예정'},
  {'id':'DOC-007','docType':'기록지','relatedWork':'N2 정기점검','relatedId':'',
   'docName':'N2 탱크 정기점검 기록지 (2026-05)','target':'N2-TANK-01, N2-TANK-02','issueDate':'2026-05-31',
   'expireDate':'','storage':'사내 공유폴더/N2/점검기록/2026','link':'','status':'등록','manager':'한상휘','note':''},
  {'id':'DOC-008','docType':'작업허가서','relatedWork':'NH3 실린더 교체','relatedId':'',
   'docName':'NH3 실린더 교체 작업허가서 (2026-06-10)','target':'NH3 Gas Cabinet','issueDate':'2026-06-10',
   'expireDate':'2026-06-10','storage':'현장 비치 후 회수 → 공유폴더','link':'','status':'보관중','manager':'한상휘','note':'SOP-001 준용 작업'}
]
evidence_js = json.dumps(evidence_samples, ensure_ascii=False)

# ── MSDS samples ──────────────────────────────────
msds_samples = [
  {'id':'MSDS-001','name':'NH3','nameEn':'Ammonia','cas':'7664-41-7','supplier':'Linde Korea',
   'location':'5F Gas Room','storage':'NH3 Gas Cabinet',
   'isHazChem':'Y','isHP':'Y','category':'독성',
   'hasMsds':'보유','revDate':'2026-01-10','lastCheckDate':'2026-06-01','nextCheckDate':'2026-12-01',
   'postLocation':'5F Gas Room 게시함','link':'','label':'완료','eduLinked':'완료',
   'relatedSopId':'SOP-001',
   'hazardSummary':'독성(흡입), 고압가스. TLV-TWA: 25ppm. LC50(rat): 4837ppm/1h.',
   'firstAid':'흡입: 즉시 신선한 공기로 이동, 의식 없으면 인공호흡. 눈/피부 노출: 다량의 물로 15분 이상 세척.',
   'handling':'방독마스크(NH3용) 착용, 환기 확인 후 작업. 가스누출 알람 작동 시 즉시 대피.',
   'ppe':'방독마스크(NH3용 정화통), 내화학 장갑, 보안경, Face Shield, 내화학복',
   'status':'정상','manager':'한상휘','note':''},
  {'id':'MSDS-002','name':'HF','nameEn':'Hydrogen Fluoride','cas':'7664-39-3','supplier':'Air Liquide Korea',
   'location':'5F Gas Room','storage':'HF Gas Cabinet',
   'isHazChem':'Y','isHP':'Y','category':'독성·부식성',
   'hasMsds':'보유','revDate':'2025-12-01','lastCheckDate':'2026-04-01','nextCheckDate':'2026-10-01',
   'postLocation':'5F Gas Room 게시함','link':'','label':'완료','eduLinked':'완료',
   'relatedSopId':'SOP-002',
   'hazardSummary':'고독성, 부식성. TLV-C: 0.5ppm. 피부 침투 시 저칼슘혈증 위험. 생명을 위협하는 화학물질.',
   'firstAid':'흡입: 즉시 신선한 공기, 119 즉시 신고. 피부: 다량의 물로 세척 후 칼슘글루코네이트 겔 도포, 즉시 응급실.',
   'handling':'반드시 2인 1조 작업, HF 응급처치 훈련자만 취급. 칼슘글루코네이트 겔 상시 휴대.',
   'ppe':'HF용 내화학복, HF용 내화학 장갑(두께 0.4mm↑), 고글+Face Shield, 방독마스크(HF용)',
   'status':'SOP 연계 완료','manager':'한상휘','note':'최고 위험 등급 물질 — 추가 안전교육 필수'},
  {'id':'MSDS-003','name':'SiF4','nameEn':'Silicon Tetrafluoride','cas':'7783-61-1','supplier':'Linde Korea',
   'location':'5F Gas Room','storage':'SiF4 Gas Cabinet',
   'isHazChem':'Y','isHP':'Y','category':'독성',
   'hasMsds':'확인필요','revDate':'','lastCheckDate':'','nextCheckDate':'2026-08-01',
   'postLocation':'','link':'','label':'확인필요','eduLinked':'해당없음',
   'relatedSopId':'SOP-003',
   'hazardSummary':'독성, 부식성. 물과 반응 시 HF 생성 가능. TLV-C: 0.1ppm.',
   'firstAid':'흡입: 신선한 공기, 의사 호출. 눈: 다량의 물 세척. HF 생성 가능성 고려하여 응급실 이송.',
   'handling':'건조 조건 유지. 수분 접촉 금지. 내식성 배관 사용.',
   'ppe':'내화학 장갑, 고글, 방독마스크(산성가스용), Face Shield',
   'status':'확인필요','manager':'한상휘','note':'MSDS 보유 여부 확인 필요 — 공급사에 재요청 예정'},
  {'id':'MSDS-004','name':'NF3','nameEn':'Nitrogen Trifluoride','cas':'7783-54-2','supplier':'SK Materials',
   'location':'4F Gas Room','storage':'NF3 Gas Cabinet',
   'isHazChem':'Y','isHP':'Y','category':'독성·산화성',
   'hasMsds':'보유','revDate':'2026-02-01','lastCheckDate':'2026-05-01','nextCheckDate':'2026-11-01',
   'postLocation':'4F Gas Room 게시함','link':'','label':'완료','eduLinked':'완료',
   'relatedSopId':'',
   'hazardSummary':'독성, 강산화제. TLV-TWA: 10ppm. 연소 지원 물질로 가연성 물질과 격리 보관.',
   'firstAid':'흡입: 신선한 공기, 산소 투여. 눈: 다량의 물로 세척. 의사 호출.',
   'handling':'가연성 물질과 격리. 밸브 조작 시 화기 금지. 슬로우 오픈.',
   'ppe':'방독마스크(산성가스용), 내화학 장갑, 보안경',
   'status':'SOP 미연계','manager':'한상휘','note':'SOP 작성 예정 (2026-Q3)'},
  {'id':'MSDS-005','name':'C3F8','nameEn':'Octafluoropropane','cas':'76-19-7','supplier':'Linde Korea',
   'location':'3F Gas Room','storage':'C3F8 Gas Cabinet',
   'isHazChem':'Y','isHP':'N','category':'독성·온실가스',
   'hasMsds':'보유','revDate':'2025-10-01','lastCheckDate':'2026-03-01','nextCheckDate':'2026-09-01',
   'postLocation':'3F Gas Room 게시함','link':'','label':'완료','eduLinked':'해당없음',
   'relatedSopId':'',
   'hazardSummary':'질식성, 고농도 노출 시 의식 상실. GWP: 8900. 누출 시 환기 필수.',
   'firstAid':'흡입: 신선한 공기, 산소 투여. 의식 없으면 인공호흡.',
   'handling':'밀폐 공간 작업 금지. 환기 충분히 확보.',
   'ppe':'산소 농도계 휴대, 방독마스크(필요 시), 보안경',
   'status':'정상','manager':'한상휘','note':'온실가스 관리 대장 별도 유지'},
  {'id':'MSDS-006','name':'KOH','nameEn':'Potassium Hydroxide','cas':'1310-58-3','supplier':'OCI',
   'location':'Utility Area','storage':'화학물질 보관소',
   'isHazChem':'Y','isHP':'N','category':'부식성',
   'hasMsds':'보유','revDate':'2025-08-01','lastCheckDate':'2026-02-01','nextCheckDate':'2026-08-01',
   'postLocation':'화학물질 보관소 게시함','link':'','label':'완료','eduLinked':'완료',
   'relatedSopId':'SOP-005',
   'hazardSummary':'강염기 부식성 물질. pH 13.5 이상. 눈 노출 시 실명 위험. 피부 심부 화상 가능.',
   'firstAid':'눈: 다량의 물로 15분 이상 세척 후 즉시 응급실. 피부: 물로 15분 세척. 섭취: 구토 유발 금지, 물 음용 후 응급실.',
   'handling':'얼굴 보호구 필수. 산성 물질과 격리. 누출 시 물로 희석 후 처리.',
   'ppe':'Face Shield+고글, 내화학 앞치마, 내화학 장갑(긴팔형), 고무장화',
   'status':'정상','manager':'한상휘','note':'KOH 리사이클 시스템 연동 물질'},
  {'id':'MSDS-007','name':'H2','nameEn':'Hydrogen','cas':'1333-74-0','supplier':'Linde Korea',
   'location':'5F/3F Gas Room','storage':'H2 Gas Cabinet',
   'isHazChem':'N','isHP':'Y','category':'인화성',
   'hasMsds':'보유','revDate':'2025-09-01','lastCheckDate':'2025-12-01','nextCheckDate':'2026-06-01',
   'postLocation':'Gas Room 게시함','link':'','label':'완료','eduLinked':'필요',
   'relatedSopId':'',
   'hazardSummary':'인화성(LFL 4%, UFL 75%). 고압가스. 무색무취로 누출 감지 어려움. 정전기 위험.',
   'firstAid':'흡입(질식): 신선한 공기, 산소. 화상: 즉시 냉각 후 응급실.',
   'handling':'화기 금지. 정전기 접지 필수. 환기 충분. H2 감지기 정상 작동 확인 후 작업.',
   'ppe':'방폭형 장갑, 보안경, 방폭 공구 사용',
   'status':'교육연계 필요','manager':'한상휘','note':'교육 자료에 H2 인화성 위험 내용 추가 필요'},
  {'id':'MSDS-008','name':'N2','nameEn':'Nitrogen','cas':'7727-37-9','supplier':'Linde Korea',
   'location':'Utility Area','storage':'N2 탱크(외부)',
   'isHazChem':'N','isHP':'Y','category':'질식성',
   'hasMsds':'보유','revDate':'2025-06-01','lastCheckDate':'2026-01-01','nextCheckDate':'2026-07-01',
   'postLocation':'Utility Area 게시함 / N2 공급실','link':'','label':'완료','eduLinked':'해당없음',
   'relatedSopId':'SOP-006',
   'hazardSummary':'질식성 가스. 고농도 시 산소 결핍 유발. 밀폐 공간 작업 시 특히 주의.',
   'firstAid':'흡입(질식): 즉시 신선한 공기, 산소 공급, 119 신고.',
   'handling':'밀폐 공간 진입 전 산소 농도 측정(18% 이상 확인). 환기 충분.',
   'ppe':'산소 농도계 휴대 필수',
   'status':'정상','manager':'한상휘','note':'N2 정기점검 일지 별도 유지'},
  {'id':'MSDS-009','name':'SF6','nameEn':'Sulfur Hexafluoride','cas':'2551-62-4','supplier':'Linde Korea',
   'location':'3F Gas Room','storage':'SF6 Gas Cabinet',
   'isHazChem':'Y','isHP':'N','category':'독성·온실가스',
   'hasMsds':'보유','revDate':'2025-11-01','lastCheckDate':'2026-04-01','nextCheckDate':'2026-10-01',
   'postLocation':'3F Gas Room 게시함','link':'','label':'완료','eduLinked':'해당없음',
   'relatedSopId':'',
   'hazardSummary':'질식성. GWP: 23500. 고농도 시 의식 상실. 분해산물(SOF2 등) 독성 주의.',
   'firstAid':'흡입: 신선한 공기. 분해산물 노출 의심 시 즉시 응급실.',
   'handling':'환기 충분. 밀폐 공간 작업 금지. 온실가스 관리 기록 유지.',
   'ppe':'산소 농도계, 방독마스크(필요 시)',
   'status':'정상','manager':'한상휘','note':'온실가스 배출량 관리 대장 별도 기록'},
  {'id':'MSDS-010','name':'LO2','nameEn':'Liquid Oxygen','cas':'7782-44-7','supplier':'Air Liquide Korea',
   'location':'Utility Area','storage':'LO2 탱크(외부)',
   'isHazChem':'N','isHP':'Y','category':'산화성·극저온',
   'hasMsds':'보유','revDate':'2026-01-01','lastCheckDate':'2026-05-01','nextCheckDate':'2026-11-01',
   'postLocation':'Utility Area 게시함','link':'','label':'완료','eduLinked':'필요',
   'relatedSopId':'',
   'hazardSummary':'강산화제. 극저온(-183°C). 가연성 물질 산화 촉진. 극저온 화상 위험.',
   'firstAid':'극저온 화상: 빠르게 따뜻한 물(38~42°C)로 세척, 응급실. 흡입: 신선한 공기.',
   'handling':'가연성 물질 격리. 극저온 보호 장갑 착용. 슬로우 오픈.',
   'ppe':'극저온 장갑, Face Shield, 보호복(내화학)',
   'status':'교육연계 필요','manager':'한상휘','note':'LO2 탱크 정기점검 시 추가 PPE 착용 필요'}
]
msds_js = json.dumps(msds_samples, ensure_ascii=False)

# ── SOP samples ────────────────────────────────────
sop_samples = [
  {'id':'SOP-001','sopName':'NH3 실린더 교체 SOP','workType':'실린더 교체','material':'NH3',
   'facility':'NH3 Gas Cabinet (5F)','relatedMsdsId':'MSDS-001',
   'version':'Rev.1','initDate':'2026-01-10','lastRevDate':'2026-06-01','nextReviewDate':'2027-06-01',
   'author':'한상휘','reviewer':'박준혁 팀장','approver':'소장','approvalStatus':'승인완료',
   'eduLinked':'완료',
   'ppe':'내화학복(전신), 내화학 장갑, 고글, Face Shield, 방독마스크(NH3용 황색 정화통)',
   'beforeWork':'① MSDS 확인 및 숙지 ② 작업허가서 취득 ③ 환기팬 작동 확인 ④ LOTO 적용 ⑤ PPE 전착용 ⑥ 가스감지기(GD-001, GD-006) 정상 확인',
   'duringWork':'① 감시자 1명 배치 ② 환기 유지(환기팬 ON) ③ 감지기 상태 상시 모니터링 ④ 실린더 교체 후 연결부 Leak Test ⑤ 이상 시 즉시 중단',
   'afterWork':'① Leak Test(비눗물/검지지) 재확인 ② 밸브 잠금 상태 확인 ③ LOTO 해제 ④ 작업일지 작성 ⑤ 감지기 알람 리셋',
   'emergency':'① 누출 감지 시 즉시 작업 중단 ② 밸브 차단 ③ 전원 차단 ④ 대피(바람 방향 유의) ⑤ 119 신고 ⑥ 관리자 즉시 보고',
   'link':'','status':'정상','manager':'한상휘','note':'반기 1회 재교육 실시'},
  {'id':'SOP-002','sopName':'HF 배관작업 SOP','workType':'배관작업','material':'HF',
   'facility':'HF Gas Cabinet (5F)','relatedMsdsId':'MSDS-002',
   'version':'Rev.0','initDate':'2026-03-01','lastRevDate':'2026-03-01','nextReviewDate':'2027-03-01',
   'author':'한상휘','reviewer':'박준혁 팀장','approver':'','approvalStatus':'검토중',
   'eduLinked':'완료',
   'ppe':'HF용 내화학복(전신), HF용 내화학 장갑(두께 0.4mm↑), 고글+Face Shield(일체형), 방독마스크(HF용 백색 정화통), 칼슘글루코네이트 겔 상시 휴대',
   'beforeWork':'① MSDS(MSDS-002) 확인 ② HF 응급처치 훈련 이수자 확인 ③ 작업허가서 취득 ④ N2 Purge 실시 ⑤ 칼슘글루코네이트 겔 현장 비치 ⑥ PPE 착용',
   'duringWork':'① 감시자 1명 필수 배치 ② HF 감지기(GD-004) 상시 확인 ③ 누출부위 육안 확인 ④ 최소 인원(2인) 투입 ⑤ 30분마다 상황 보고',
   'afterWork':'① Leak Test 실시 ② N2 Purge 후 복구 ③ 밸브 잠금 확인 ④ 기록 작성 ⑤ 칼슘글루코네이트 겔 재보충',
   'emergency':'① HF 누출 시 즉시 대피(바람 방향 등지) ② 피부 노출: 즉시 물로 세척 후 칼슘글루코네이트 겔 도포 ③ 119 신고 및 응급실 이송 ④ 절대 방치 금지',
   'link':'','status':'승인필요','manager':'한상휘','note':'승인자(소장) 확정 후 최종 승인 예정. HF 특성상 최우선 처리 필요.'},
  {'id':'SOP-003','sopName':'SiF4 Hook-up SOP','workType':'Hook-up','material':'SiF4',
   'facility':'SiF4 Gas Cabinet (5F)','relatedMsdsId':'MSDS-003',
   'version':'Draft','initDate':'2026-05-01','lastRevDate':'','nextReviewDate':'',
   'author':'한상휘','reviewer':'','approver':'','approvalStatus':'작성중',
   'eduLinked':'해당없음',
   'ppe':'내화학복, 방독마스크(산성가스용), 고글+Face Shield, 내화학 장갑',
   'beforeWork':'(작성 예정)', 'duringWork':'(작성 예정)', 'afterWork':'(작성 예정)',
   'emergency':'누출 시 대피, 119 신고. SiF4+수분 → HF 발생 가능 — HF SOP 비상조치 준용.',
   'link':'','status':'MSDS 확인 필요','manager':'한상휘','note':'MSDS-003 확인 완료 후 SOP 완성 예정 (2026-08)'},
  {'id':'SOP-004','sopName':'가스감지기 알람 대응 SOP','workType':'비상대응','material':'공통',
   'facility':'전 층 Gas Detector','relatedMsdsId':'해당없음',
   'version':'Rev.1','initDate':'2025-12-01','lastRevDate':'2026-01-01','nextReviewDate':'2027-01-01',
   'author':'한상휘','reviewer':'박준혁 팀장','approver':'소장','approvalStatus':'승인완료',
   'eduLinked':'필요',
   'ppe':'방독마스크(해당 가스 정화통), 보호복 (현장 상황에 따라 선택)',
   'beforeWork':'① 알람 발생 층 즉시 확인 ② 알람 가스 종류 파악 ③ 해당 MSDS 확인 ④ 대피 준비 태세',
   'duringWork':'① 가스 종류·농도 확인 (감지기 디스플레이) ② 1차 알람: 경고(작업 중단, 원인 파악) ③ 2차 알람: 즉시 대피 지시 ④ 비상연락망 가동',
   'afterWork':'① 원인 조사 및 기록 ② 가스 공급 차단 후 환기 ③ 재발 방지 대책 수립 ④ 관련 기관 보고(필요 시)',
   'emergency':'① 지속 알람: 즉시 전원 대피 ② 비상구 이용 ③ 119 + 관리소장 동시 신고 ④ 대피 후 인원 확인',
   'link':'','status':'교육연계 필요','manager':'한상휘','note':'비상대응 훈련 반기 1회 실시 필요'},
  {'id':'SOP-005','sopName':'KOH 취급 및 보충 SOP','workType':'점검','material':'KOH',
   'facility':'KOH 리사이클 시스템 / 화학물질 보관소','relatedMsdsId':'MSDS-006',
   'version':'Rev.1','initDate':'2025-11-01','lastRevDate':'2026-02-01','nextReviewDate':'2027-02-01',
   'author':'한상휘','reviewer':'박준혁 팀장','approver':'소장','approvalStatus':'승인완료',
   'eduLinked':'완료',
   'ppe':'Face Shield+고글, 내화학 앞치마, 내화학 장갑(긴팔형), 고무장화, 내화학복(전신 필요 시)',
   'beforeWork':'① MSDS(MSDS-006) 확인 ② 보호구 착용 ③ 누출 대응 자재(흡착포, 중화제) 준비 ④ 환기 확인',
   'duringWork':'① 슬로우 오픈으로 밸브 조작 ② 누출 여부 육안 확인 ③ 눈 보호(Face Shield) 상시 착용',
   'afterWork':'① 밸브 잠금 확인 ② 사용 용기 밀봉 보관 ③ 작업 구역 세척 ④ 작업일지 기록',
   'emergency':'① 눈 노출: 즉시 다량의 물로 15분 세척 후 응급실 ② 피부: 다량의 물 세척 ③ 섭취: 구토 유발 금지, 응급실',
   'link':'','status':'정상','manager':'한상휘','note':''},
  {'id':'SOP-006','sopName':'N2 공급 설비 점검 SOP','workType':'점검','material':'N2',
   'facility':'N2 탱크 / N2 공급 라인','relatedMsdsId':'MSDS-008',
   'version':'Rev.0','initDate':'2025-10-01','lastRevDate':'2025-10-01','nextReviewDate':'2026-10-01',
   'author':'한상휘','reviewer':'','approver':'','approvalStatus':'검토중',
   'eduLinked':'해당없음',
   'ppe':'산소 농도계 필수 휴대, 보안경, 보호장갑',
   'beforeWork':'① 산소 농도 측정(18% 이상 확인) ② 환기 확인 ③ 개인 산소 농도계 착용',
   'duringWork':'① 산소 농도 상시 모니터링 ② 밀폐 공간 진입 금지 ③ 2인 1조 작업',
   'afterWork':'① 밸브 잠금 확인 ② 산소 농도 재확인 ③ 점검 기록 작성',
   'emergency':'① 산소 결핍 의심 시 즉시 대피 ② 119 신고 ③ 구조 시 구조자도 보호장비 필수 착용',
   'link':'','status':'승인필요','manager':'한상휘','note':'N2 정기점검 일지와 연계'},
  {'id':'SOP-007','sopName':'NF3 실린더 교체 SOP','workType':'실린더 교체','material':'NF3',
   'facility':'NF3 Gas Cabinet (4F)','relatedMsdsId':'MSDS-004',
   'version':'','initDate':'','lastRevDate':'','nextReviewDate':'',
   'author':'한상휘','reviewer':'','approver':'','approvalStatus':'작성중',
   'eduLinked':'해당없음',
   'ppe':'내화학복, 방독마스크(산성가스용), 고글, 내화학 장갑',
   'beforeWork':'(작성 예정)', 'duringWork':'(작성 예정)', 'afterWork':'(작성 예정)',
   'emergency':'NF3 누출 시 즉시 대피, 산화성 가스이므로 가연성 물질 즉시 격리, 119 신고.',
   'link':'','status':'작성중','manager':'한상휘','note':'MSDS-004 연계 예정'},
  {'id':'SOP-008','sopName':'H2 Gas Cabinet 정기점검 SOP','workType':'점검','material':'H2',
   'facility':'H2 Gas Cabinet','relatedMsdsId':'MSDS-007',
   'version':'Rev.0','initDate':'2026-04-01','lastRevDate':'2026-04-01','nextReviewDate':'2027-04-01',
   'author':'한상휘','reviewer':'박준혁 팀장','approver':'','approvalStatus':'검토중',
   'eduLinked':'필요',
   'ppe':'방폭형 보호장갑, 보안경, 정전기 방지 의류, 방폭 공구',
   'beforeWork':'① 화기 금지 표시 확인 ② 정전기 접지 확인 ③ 환기 팬 작동 ④ H2 감지기 정상 확인',
   'duringWork':'① 화기 및 전자기기 사용 금지 ② 슬로우 오픈 ③ Leak Test 실시 ④ 감지기 알람 상시 확인',
   'afterWork':'① 밸브 잠금 ② 점검 기록 작성 ③ 감지기 정상 복귀 확인',
   'emergency':'인화 시 즉시 대피, 화기 금지, 119 신고. 소화: CO2 또는 건식 분말 소화기.',
   'link':'','status':'승인필요','manager':'한상휘','note':'H2 고압가스 특성상 방폭 공구 필수 사용'}
]
...
.sb{{display:inline-block;padding:2px 8px;border-radius:10px;font-size:10px;font-weight:700;white-space:nowrap;}}
.sb-green{{background:#d4edda;color:#155724;}}
.sb-blue{{background:#cce5ff;color:#004085;}}
.sb-orange{{background:#FFF3CD;color:#664d03;}}
.sb-red{{background:#f8d7da;color:#842029;}}
.sb-gray{{background:#EEF3FA;color:#6c757d;}}
/* ── Table row selection ── */
.tbl-sel td{{background:#EEF3FA!important;}}
.tbl-sel td:first-child{{box-shadow:inset 3px 0 0 #0047B0;}}
/* ── AX box ── */
...
<div id="sidebar">
  ...
  <div style="padding:4px 0 8px;">
    ...
    <div class="nav-group-items" id="navg-legal">
      ...
      <button class="nav-item" onclick="gp('msds',this)">MSDS 관리</button>
      <button class="nav-item" onclick="gp('sop',this)">SOP 관리</button>
    </div>
...
<div id="page-summary" class="page">
  ...
  <div class="sec-title">법정기한 관리 현황</div>
  <div id="sumDeadlineKpi" class="kpi-grid" style="grid-template-columns:repeat(5,1fr);margin-bottom:16px;"></div>

  <div class="sec-title">증빙자료 관리 현황</div>
  <div id="sumEvidenceKpi" class="kpi-grid" style="grid-template-columns:repeat(5,1fr);margin-bottom:16px;"></div>

  <div class="sec-title">MSDS 관리 현황</div>
  <div id="sumMsdsKpi" class="kpi-grid" style="grid-template-columns:repeat(6,1fr);margin-bottom:16px;"></div>
...
<!-- MSDS PAGE -->
<div id="page-msds" class="page">
  <div class="dash-header">
    <div>
      <div class="dash-header-title">MSDS 관리</div>
      <div class="dash-header-sub">물질별 MSDS 보유·최신성·게시위치·교육연계·SOP 연계 관리</div>
    </div>
  </div>
  <div class="sn">🔖 운영회의 검토용 MVP 데이터입니다. 실제 운영 시 Raw Data 연동 예정입니다.</div>
  <!-- 조회 모드 배너 -->
  <div id="msdsViewBanner" style="background:#EEF3FA;border:1px solid #C8D8F0;border-radius:7px;padding:8px 14px;margin-bottom:10px;font-size:12px;color:#4A6A9A;display:flex;align-items:center;gap:8px;">
    🔒 조회 모드 — 데이터 수정은 <b>데이터 편집</b> 메뉴(ADMIN 모드)에서 가능합니다.
  </div>
  <div id="msdsAdminBanner" style="display:none;background:#FFF8E1;border:1px solid #E8960A;border-radius:7px;padding:8px 14px;margin-bottom:10px;font-size:12px;color:#664d03;align-items:center;gap:8px;">
    🔓 ADMIN 모드 — <b>데이터 편집</b> 메뉴에서 MSDS 데이터를 수정할 수 있습니다.
  </div>
  <!-- KPI -->
  <div class="kpi-grid" id="msdsKpiGrid" style="grid-template-columns:repeat(7,1fr);margin-bottom:12px;"></div>
  <!-- 필터 -->
  <div class="cbox" style="padding:10px 14px;margin-bottom:10px;display:flex;gap:8px;flex-wrap:wrap;align-items:center;">
    <select id="msdsFilterHaz" onchange="filterMsds()" style="padding:5px 8px;border:1px solid #C8D8F0;border-radius:5px;font-size:12px;font-family:inherit;">
      <option value="">유해화학물질 전체</option><option value="Y">Y</option><option value="N">N</option><option value="확인필요">확인필요</option>
    </select>
    <select id="msdsFilterHP" onchange="filterMsds()" style="padding:5px 8px;border:1px solid #C8D8F0;border-radius:5px;font-size:12px;font-family:inherit;">
      <option value="">고압가스 전체</option><option value="Y">Y</option><option value="N">N</option>
    </select>
    <select id="msdsFilterSt" onchange="filterMsds()" style="padding:5px 8px;border:1px solid #C8D8F0;border-radius:5px;font-size:12px;font-family:inherit;">
      <option value="">상태 전체</option><option value="정상">정상</option><option value="확인필요">확인필요</option>
      <option value="미보유">미보유</option><option value="게시위치 미등록">게시위치 미등록</option>
      <option value="교육연계 필요">교육연계 필요</option><option value="SOP 미연계">SOP 미연계</option>
    </select>
    <input type="text" id="msdsSearch" oninput="filterMsds()" placeholder="물질명·CAS·담당자 검색" style="padding:5px 8px;border:1px solid #C8D8F0;border-radius:5px;font-size:12px;font-family:inherit;width:180px;">
    <span id="msdsFilterCount" style="font-size:11px;color:#7A96C0;margin-left:8px;"></span>
  </div>
  <!-- 목록 + 상세 -->
  <div class="row73">
    <div class="cbox" style="overflow-x:auto;padding:10px;">
      <table class="dtable" style="min-width:740px;">
        <thead><tr>
          <th>MSDS ID</th><th>물질명</th><th>유해</th><th>고압</th><th>구분</th>
          <th>상태</th><th>연계현황</th><th>차기 확인일</th><th>게시위치</th><th>담당자</th>
        </tr></thead>
        <tbody id="msdsTbody"></tbody>
      </table>
    </div>
    <div id="msdsDetailPanel" style="display:none;border:2px solid #003087;border-radius:8px;padding:14px;background:#FAFCFF;overflow-y:auto;max-height:600px;"></div>
  </div>
</div>
...
<div id="page-sop" class="page">
  <div class="dash-header">
    <div>
      <div class="dash-header-title">SOP 관리</div>
      <div class="dash-header-sub">작업별 표준작업절차 / PPE 기준 / 비상조치 / MSDS·교육 연계</div>
    </div>
  </div>
  <div class="sn">🔖 운영회의 검토용 MVP 데이터입니다. 실제 운영 시 Raw Data 연동 예정입니다.</div>
  <!-- 조회 모드 배너 -->
  <div id="sopViewBanner" style="background:#EEF3FA;border:1px solid #C8D8F0;border-radius:7px;padding:8px 14px;margin-bottom:10px;font-size:12px;color:#4A6A9A;display:flex;align-items:center;gap:8px;">
    🔒 조회 모드 — 데이터 수정은 <b>데이터 편집</b> 메뉴(ADMIN 모드)에서 가능합니다.
  </div>
  <div id="sopAdminBanner" style="display:none;background:#FFF8E1;border:1px solid #E8960A;border-radius:7px;padding:8px 14px;margin-bottom:10px;font-size:12px;color:#664d03;align-items:center;gap:8px;">
    🔓 ADMIN 모드 — <b>데이터 편집</b> 메뉴에서 SOP 데이터를 수정할 수 있습니다.
  </div>
  <!-- KPI -->
  <div class="kpi-grid" id="sopKpiGrid" style="grid-template-columns:repeat(7,1fr);margin-bottom:12px;"></div>
  <!-- 필터 -->
  <div class="cbox" style="padding:10px 14px;margin-bottom:10px;display:flex;gap:8px;flex-wrap:wrap;align-items:center;">
    <select id="sopFilterType" onchange="filterSop()" style="padding:5px 8px;border:1px solid #C8D8F0;border-radius:5px;font-size:12px;font-family:inherit;">
      <option value="">작업구분 전체</option><option value="실린더 교체">실린더 교체</option><option value="배관작업">배관작업</option>
      <option value="Hook-up">Hook-up</option><option value="점검">점검</option><option value="비상대응">비상대응</option>
    </select>
    <select id="sopFilterAppr" onchange="filterSop()" style="padding:5px 8px;border:1px solid #C8D8F0;border-radius:5px;font-size:12px;font-family:inherit;">
      <option value="">승인상태 전체</option><option value="승인완료">승인완료</option><option value="검토중">검토중</option>
      <option value="작성중">작성중</option><option value="개정필요">개정필요</option>
    </select>
    <select id="sopFilterSt" onchange="filterSop()" style="padding:5px 8px;border:1px solid #C8D8F0;border-radius:5px;font-size:12px;font-family:inherit;">
      <option value="">상태 전체</option><option value="정상">정상</option><option value="승인필요">승인필요</option>
      <option value="개정필요">개정필요</option><option value="문서 미등록">문서 미등록</option>
      <option value="교육연계 필요">교육연계 필요</option><option value="MSDS 미연계">MSDS 미연계</option>
    </select>
    <input type="text" id="sopSearch" oninput="filterSop()" placeholder="SOP명·물질·담당자 검색" style="padding:5px 8px;border:1px solid #C8D8F0;border-radius:5px;font-size:12px;font-family:inherit;width:180px;">
    <span id="sopFilterCount" style="font-size:11px;color:#7A96C0;margin-left:8px;"></span>
  </div>
  <!-- 목록 + 상세 -->
  <div class="row73">
    <div class="cbox" style="overflow-x:auto;padding:10px;">
      <table class="dtable" style="min-width:740px;">
        <thead><tr>
          <th>SOP ID</th><th>SOP명</th><th>작업구분</th><th>대상물질</th><th>버전</th>
          <th>승인상태</th><th>차기 검토일</th><th>교육연계</th><th>MSDS연계</th><th>상태</th><th>담당자</th>
        </tr></thead>
        <tbody id="sopTbody"></tbody>
      </table>
    </div>
    <div id="sopDetailPanel" style="display:none;border:2px solid #003087;border-radius:8px;padding:14px;background:#FAFCFF;overflow-y:auto;max-height:600px;"></div>
  </div>
</div>
    ...
    <table class="dtable" style="min-width:1520px;">
      <thead>
        <tr style="background:#003087;">
          ...
          <th style="color:white;width:110px;">차기 교정일</th>
          <th style="color:white;text-align:center;width:80px;">D-Day</th>
...
<!-- DEADLINE PAGE -->
<div id="page-deadline" class="page">
  <div class="dash-header">
    <div>
      <div class="dash-header-title">법정기한 관리<span class="dash-badge">D-Day</span></div>
      <div class="dash-header-sub">교육·검사·교정·신고 등 기한성 업무 D-Day 기준 관리 | ADMIN 모드에서 등록·수정·삭제 가능</div>
    </div>
    <div style="display:flex;gap:12px;align-items:center;">
      <div style="text-align:right;">
        <div style="font-size:11px;color:rgba(255,255,255,0.85);font-weight:600;" id="dlLastSaved">저장 없음</div>
        <div style="font-size:10px;color:rgba(255,255,255,0.55);">마지막 저장</div>
      </div>
      <button onclick="openAdminModal()" style="background:transparent;color:white;border:2px solid rgba(255,255,255,0.65);padding:7px 18px;border-radius:7px;font-size:12px;font-weight:700;cursor:pointer;white-space:nowrap;">🔒 ADMIN</button>
    </div>
  </div>
  <div id="dlViewBanner" style="background:#EEF3FA;border:1px solid #C8D8F0;border-radius:7px;padding:9px 14px;margin-bottom:12px;font-size:12px;color:#4A6A9A;display:flex;align-items:center;gap:8px;">
    🔒 현재 <b>조회 모드</b>입니다. 데이터를 수정하려면 우측 상단 <b>ADMIN</b> 버튼을 누르세요.
  </div>
  <div id="dlAdminBanner" style="display:none;background:#FFF8E1;border:1px solid #E8960A;border-radius:7px;padding:9px 14px;margin-bottom:12px;font-size:12px;color:#664d03;align-items:center;gap:8px;">
    🔓 <b>관리자 편집 모드</b>입니다.
    <button onclick="setAdminMode(false)" style="margin-left:auto;background:#E8960A;color:white;border:none;padding:5px 14px;border-radius:5px;font-size:11px;font-weight:600;cursor:pointer;">편집 모드 해제</button>
  </div>

  <div id="deadlineKpiGrid" class="kpi-grid" style="grid-template-columns:repeat(7,1fr);margin-bottom:12px;"></div>

  <!-- 필터 -->
  <div class="cbox" style="margin-bottom:12px;">
    <div style="display:flex;gap:10px;align-items:flex-end;flex-wrap:wrap;">
      <div class="edit-row"><label>구분</label>
        <select id="dlFilterCat" onchange="filterDeadlines()" style="padding:5px 8px;border:1px solid #C8D8F0;border-radius:5px;font-size:12px;font-family:inherit;">
          <option value="">전체</option>
          <option>교육</option><option>검사</option><option>교정</option><option>신고</option><option>점검</option><option>인허가</option>
        </select>
      </div>
      <div class="edit-row"><label>상태</label>
        <select id="dlFilterSt" onchange="filterDeadlines()" style="padding:5px 8px;border:1px solid #C8D8F0;border-radius:5px;font-size:12px;font-family:inherit;">
          <option value="">전체</option>
          <option>정상</option><option>예정</option><option>임박</option><option>초과</option><option>완료</option><option>확인필요</option>
        </select>
      </div>
      <div class="edit-row"><label>증빙 등록</label>
        <select id="dlFilterEv" onchange="filterDeadlines()" style="padding:5px 8px;border:1px solid #C8D8F0;border-radius:5px;font-size:12px;font-family:inherit;">
          <option value="">전체</option>
          <option value="등록">등록</option><option value="미등록">미등록</option><option value="해당없음">해당없음</option>
        </select>
      </div>
      <div class="edit-row"><label>검색어</label>
        <input type="text" id="dlSearch" oninput="filterDeadlines()" placeholder="항목명·대상·담당자" style="padding:5px 8px;border:1px solid #C8D8F0;border-radius:5px;font-size:12px;font-family:inherit;width:160px;">
      </div>
      <span style="font-size:11px;color:#7A96C0;align-self:center;" id="dlFilterCount"></span>
      <button id="addDeadlineBtn" class="btn-apply" onclick="addNewDeadline()" disabled style="font-size:12px;padding:7px 16px;align-self:flex-end;">+ 신규 등록</button>
      <button class="btn-save" id="saveDeadlineBtn" onclick="saveDeadlineSection()" disabled style="align-self:flex-end;">💾 저장</button>
    </div>
  </div>
  ...
  <div class="cbox" style="overflow-x:auto;margin-bottom:12px;">
    <table class="dtable" style="min-width:1100px;">
      <thead>
        <tr style="background:#003087;">
          <th style="color:white;width:70px;">기한ID</th>
          <th style="color:white;width:65px;">구분</th>
          <th style="color:white;min-width:150px;">관리항목</th>
          <th style="color:white;width:110px;">대상</th>
          <th style="color:white;width:90px;">예정일</th>
          <th style="color:white;width:70px;">D-Day</th>
          <th style="color:white;width:75px;">상태</th>
          <th style="color:white;width:80px;">담당자</th>
          <th style="color:white;width:75px;">증빙등록</th>
          <th style="color:white;width:100px;">관련메뉴</th>
          <th style="color:white;width:55px;">상세</th>
        </tr>
      </thead>
  ...
  <!-- 상세 패널 -->
  <div id="deadlineDetailPanel" style="display:none;border:2px solid #003087;border-radius:8px;padding:16px;background:#FAFCFF;margin-bottom:10px;"></div>
</div>
...
<div id="page-evidence" class="page">
  <div class="dash-header">
    <div>
      <div class="dash-header-title">증빙자료 관리<span class="dash-badge">문서 관리</span></div>
      <div class="dash-header-sub">검사필증·수료증·성적서·신고서 등 문서 보관위치 및 유효기한 관리 | ADMIN 모드에서 등록·수정·삭제 가능</div>
    </div>
    <div style="display:flex;gap:12px;align-items:center;">
      <div style="text-align:right;">
        <div style="font-size:11px;color:rgba(255,255,255,0.85);font-weight:600;" id="evLastSaved">저장 없음</div>
        <div style="font-size:10px;color:rgba(255,255,255,0.55);">마지막 저장</div>
      </div>
      <button onclick="openAdminModal()" style="background:transparent;color:white;border:2px solid rgba(255,255,255,0.65);padding:7px 18px;border-radius:7px;font-size:12px;font-weight:700;cursor:pointer;white-space:nowrap;">🔒 ADMIN</button>
    </div>
  </div>
  <div id="evViewBanner" style="background:#EEF3FA;border:1px solid #C8D8F0;border-radius:7px;padding:9px 14px;margin-bottom:12px;font-size:12px;color:#4A6A9A;display:flex;align-items:center;gap:8px;">
    🔒 현재 <b>조회 모드</b>입니다. 데이터를 수정하려면 우측 상단 <b>ADMIN</b> 버튼을 누르세요.
  </div>
  <div id="evAdminBanner" style="display:none;background:#FFF8E1;border:1px solid #E8960A;border-radius:7px;padding:9px 14px;margin-bottom:12px;font-size:12px;color:#664d03;align-items:center;gap:8px;">
    🔓 <b>관리자 편집 모드</b>입니다.
    <button onclick="setAdminMode(false)" style="margin-left:auto;background:#E8960A;color:white;border:none;padding:5px 14px;border-radius:5px;font-size:11px;font-weight:600;cursor:pointer;">편집 모드 해제</button>
  </div>

  <div id="evidenceKpiGrid" class="kpi-grid" style="grid-template-columns:repeat(6,1fr);margin-bottom:12px;"></div>

  <!-- 필터 -->
  <div class="cbox" style="margin-bottom:12px;">
    <div style="display:flex;gap:10px;align-items:flex-end;flex-wrap:wrap;">
      <div class="edit-row"><label>문서구분</label>
        <select id="evFilterType" onchange="filterEvidence()" style="padding:5px 8px;border:1px solid #C8D8F0;border-radius:5px;font-size:12px;font-family:inherit;">
          <option value="">전체</option>
          <option>검사필증</option><option>수료증</option><option>성적서</option><option>신고서</option><option>작업허가서</option><option>기타</option>
        </select>
      </div>
      <div class="edit-row"><label>등록상태</label>
        <select id="evFilterSt" onchange="filterEvidence()" style="padding:5px 8px;border:1px solid #C8D8F0;border-radius:5px;font-size:12px;font-family:inherit;">
          <option value="">전체</option>
          <option>등록</option><option>보관중</option><option>미등록</option><option>만료</option><option>만료예정</option><option>연결필요</option><option>확인필요</option>
        </select>
      </div>
      <div class="edit-row"><label>검색어</label>
        <input type="text" id="evSearch" oninput="filterEvidence()" placeholder="문서명·대상·담당자" style="padding:5px 8px;border:1px solid #C8D8F0;border-radius:5px;font-size:12px;font-family:inherit;width:160px;">
      </div>
      <span style="font-size:11px;color:#7A96C0;align-self:center;" id="evFilterCount"></span>
      <button id="addEvidenceBtn" class="btn-apply" onclick="addNewEvidence()" disabled style="font-size:12px;padding:7px 16px;align-self:flex-end;">+ 신규 등록</button>
      <button class="btn-save" id="saveEvidenceBtn" onclick="saveEvidenceSection()" disabled style="align-self:flex-end;">💾 저장</button>
    </div>
  </div>
  ...
  <div class="cbox" style="overflow-x:auto;margin-bottom:12px;">
    <table class="dtable" style="min-width:1000px;">
      <thead>
        <tr style="background:#003087;">
          <th style="color:white;width:70px;">문서ID</th>
          <th style="color:white;width:80px;">문서구분</th>
          <th style="color:white;min-width:160px;">문서명</th>
          <th style="color:white;width:100px;">대상</th>
          <th style="color:white;width:90px;">발행일</th>
          <th style="color:white;width:90px;">유효기한</th>
          <th style="color:white;width:80px;">등록상태</th>
          <th style="color:white;width:75px;">담당자</th>
          <th style="color:white;width:80px;">관련ID</th>
          <th style="color:white;width:55px;">상세</th>
        </tr>
      </thead>
  ...
  <!-- 상세 패널 -->
  <div id="evidenceDetailPanel" style="display:none;border:2px solid #003087;border-radius:8px;padding:16px;background:#FAFCFF;margin-bottom:10px;"></div>
</div>
